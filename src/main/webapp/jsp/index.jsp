		...
		<c:choose>
			...
			<c:when test="${mode == 'PARTICIPANT_EDIT' || mode == 'PARTICIPANT_CREATE'}">
				<form action="save" method="POST">
					...
					<div class="form-group">
						<label for="level">level:</label>
						<input type="text" list='level-list' class="form-control" id="level" name="level" value="${participant.level}">
						<datalist id='level-list'>
							<option label='L1' value='L1'>
							<option label='L2' value='L2'>
							<option label='L3' value='L3'>
							<option label='L4' value='L4'>
							<option label='L5' value='L5'>
						</datalist>
					</div>
